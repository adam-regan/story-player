...
extension Story {
    static let testData: [Story] = [
        Story(title: "Little Red Riding Hood", description: "A young girl is chased by a cunning wolf", author: "Horace E. Scudder", imageUrl: "little-red-riding-hood", url: "little-red-riding-hood"),
